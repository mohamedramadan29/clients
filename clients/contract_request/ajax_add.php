...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($formerror)) {
        $stmt = $connect->prepare("INSERT INTO contract_report
                     (con_client_name,con_legal,con_account_num,tax_number,con_uniq_num,con_account_type,
                ...
                VALUES (:zcon_client_name,:zcon_legal,:zcon_account_num,:ztax_number,:zcon_uniq_num,:zcon_account_type,
        ...
        $stmt->execute([
            ...
            'zcon_account_num' => $con_account_num, 'ztax_number' => $tax_number,
            'zcon_uniq_num' => $con_uniq_num,
