                ...
                <div class="col-lg-12">
                    <div class="form-data">
                        ...
                        <div class="table-responsive">
                            <table id="" class="table table-hover table-bordered services_stage">
                                <thead>
                                    <tr>
                                        <th> المرحلة </th>
                                        <th> التاريخ </th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if (isset($_POST['send_file1'])) {
                                                ...
                                                $stmt = $connect->prepare("UPDATE accounting_report SET file=? , send_sign_contract_payment_receipt	= 1  WHERE ar_id=?");
                                                $stmt->execute(array(
                                                    $send_sign_contract_uploaded, $ar_id
                                                ));
                                                if ($stmt) {
                                            ?>
                                                    <script>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if (isset($_POST['send_end_fee_send'])) {
                                                ...
                                                $stmt = $connect->prepare("UPDATE accounting_report SET file_end_fee=? , send_end_fee = 1  WHERE ar_id=?");
                                                $stmt->execute(array(
                                                    $send_end_fee_uploaded, $ar_id
                                                ));
                                                if ($stmt) {
                                            ?>
                                                    <script>
