                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if (isset($_POST['send_file1'])) {
                                                ...
                                                $stmt = $connect->prepare("UPDATE  tax_report SET file=? , send_sign_contract_payment_receipt	= 1  WHERE tax_id=?");
                                                $stmt->execute(array(
                                                    $send_sign_contract_uploaded, $tax_id
                                                ));
                                                if ($stmt) {
                                            ?>
                                                    <script>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if (isset($_POST['send_end_fee_send'])) {
                                                ...
                                                $stmt = $connect->prepare("UPDATE tax_report SET file_end_fee=? , send_end_fee = 1  WHERE tax_id=?");
                                                $stmt->execute(array(
                                                    $send_end_fee_uploaded, $tax_id
                                                ));
                                                if ($stmt) {
                                            ?>
                                                    <script>
