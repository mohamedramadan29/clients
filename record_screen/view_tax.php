...
<div class="container-fluid">
    <div class="data">
        <div class="bread">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">تفاصيل نموذج طلب عقد ارتباط لخدمة زكاة وضرائب </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="myform">
            <!-- ********************** END CODE ********************** -->
            <form id="edit_form" class="form-group message_form ajax_form" action="main_ajax.php?dir=record_screen&page=edit_tax" method="POST" autocomplete="on" enctype="multipart/form-data">
                <div class="row">
                ...
                <div class="col-lg-4 d-none">
                    <div class="form-data">
                        ...
                        <div class="box3">
                            ...
                            <input class="form-control" type="date" name="date_issuance" value="<?php echo $tax_data['date_issuance'] ?>">
                        </div>
                        <div class="box3">
                            <label id="car_model"> تاريخ بدء الخدمة </label>
                            <input class="form-control" type="date" name="date_start_services" value="<?php echo $tax_data['date_start_services'] ?>">
                        </div>
                        <div class="box3">
                            <label id="car_model"> تاريخ انتهاء الخدمة </label>
                            <input class="form-control" type="date" name="date_end_services" value="<?php echo $tax_data['date_end_services'] ?>">
                        </div>
                        <div class="box3">
                            <label id="car_model"> ارفاق عقد موقع </label>
                            <select name="send_signed_contract" id="" class="form-control">
                                <option value=""> -- اختر -- </option>
                                <option <?php if ($tax_data['send_signed_contract'] == '0') echo 'selected'; ?> value="1"> تم الارفاق </option>
                                <option <?php if ($tax_data['send_signed_contract'] == '0') echo 'selected'; ?> value="0"> لم يتم الارفاق </option>
                            </select>
                        </div>
                        <div class="box3">
                            ...
                            <select name="send_payment_fee" id="" class="form-control">
                                <option value=""> -- اختر -- </option>
                                <option <?php if ($tax_data['send_payment_fee'] == '1') echo 'selected'; ?> value="1"> تم الارفاق </option>
                                <option <?php if ($tax_data['send_payment_fee'] == '0') echo 'selected'; ?> value="0">لم يتم الارفاق</option>
                            </select>
                        </div>
                        <div class="box3">
                            ...
                            <select name="status" id="" class="form-control">
                                <option value=""> -- اختر -- </option>
                                <option <?php if ($tax_data['status'] == '1') echo 'selected'; ?> value="1"> انتهت </option>
                                <option <?php if ($tax_data['status'] == '0') echo 'selected'; ?> value="0"> قائمة </option>
                            </select>
                        </div>
                        <p class="alert alert-info"> مراحل طلب الخدمة </p>
                        <div class="box3">
                            <label id="car_model"> تاريخ الموافقة على نموذج الخدمة </label>
                            <input class="form-control" type="date" name="agree_services" value="<?php echo $tax_data['agree_services'] ?>">
                        </div>
                        <div class="box3">
                            <label id="car_model"> تاريخ إرسال عقد الارتباط </label>
                            <input class="form-control" type="date" name="send_link_note" value="<?php echo $tax_data['send_link_note'] ?>">
                        </div>
                        <div class="box3">
                            <label id="car_model"> تاريخ إرسال العقد الموقع وايصالات السداد </label>
                            <input class="form-control" type="date" name="send_sign_contract_payment_receipt" value="<?php echo $tax_data['send_sign_contract_payment_receipt'] ?>">
                        </div>
                        <div class="box3">
                            <label id="car_model"> تاريخ التحقق من توقيع العقد وايصالات السداد </label>
                            <input class="form-control" type="date" name="verification_contract_req" value="<?php echo $tax_data['verification_contract_req'] ?>">
                        </div>
                        <div class="box3">
                            <label id="car_model"> تاريخ الانتهاء من أعمال المراجعة </label>
                            <input class="form-control" type="date" name="end_revision_work" value="<?php echo $tax_data['end_revision_work'] ?>">
                        </div>
                        <div class="box3">
                            <label id="car_model"> تاريخ إرسال ايصال سداد الدفعة الأخيرة </label>
                            <input class="form-control" type="date" name="send_end_fee" value="<?php echo $tax_data['send_end_fee'] ?>">
                        </div>
                        <div class="box3">
                            <label id="car_model"> تاريخ إيداع في منصة قوائم </label>
                            <input class="form-control" type="date" name="deposit_plat_form" value="<?php echo $tax_data['deposit_plat_form'] ?>">
                        </div>
                        <div class="box">
                            <label id="car_model"> ملاحظات </label>
                            <textarea name="notes" class="form-control"><?php echo $tax_data['notes'] ?></textarea>
                        </div>
                        <div class="box text-center">
