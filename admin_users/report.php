            ...
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"> <i class="fa fa-heart"></i> <a
                            href="main.php?dir=dashboard&page=dashboard"> <?php echo $website_title; ?></a> <i
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="myform">
                            <form class="form-group insert ajax_form" action="main_ajax.php?dir=admin_users&page=add"
                                ...
                                <div class="row">
                                    ...
                                    <div class="box submit_box">
                                        <input class="btn btn-outline-primary btn-sm" name="add_car" type="submit"
                                            value=" اضافه مستخدم جديد ">
                                    </div>
                                </div>
                        </div>
                        </form>
    ...
    <div class="table-responsive">
        ...
        <table id="tableone" class="table table-light table-striped table-hover table-bordered">
            ...
            foreach ($alltype as $type) { ?> <tr>
                    ...
                    <td> <a href="main.php?dir=record_screen&page=view&user_id=<?php echo $type[
                        'user_id'
                    ]; ?>" class="btn btn-outline-primary btn-sm"> حركة الحساب </a> </td>
                    <td>
                        ...
                        <?php } ?>
                    <td>
                        <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#viewrecord<?php echo $type[
                            'user_id'
                        ]; ?>">
                            <i class="fa fa-eye"></i>
                        </button>
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editrecord<?php echo $type[
                            'user_id'
                        ]; ?>">
                            <i class="fa fa-edit"></i>
                        </button>
                        <a class="confirm btn btn-danger" href="main.php?dir=admin_users&page=delete&user_id=<?php echo $type[
                            'user_id'
                        ]; ?> ">
                ...
                <!-- Modal -->
                <div class="modal fade edit_form" id="editrecord<?php echo $type[
                    'user_id'
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="data">
                                    <div class="myform">
                                        <form class="form-group insert ajax_form"
                                            action="main_ajax.php?dir=admin_users&page=edit" method="POST"
                                            autocomplete="on" enctype="multipart/form-data">
                                            <input type="hidden" name="user_id" value="<?php echo $type[
                                                'user_id'
                                            ]; ?>">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="box2">
                                                        ...
                                                        <input class="form-control" type="text"
                                                            name="user_personal_name" value="<?php echo $type[
                                                                'user_personal_name'
                                                            ]; ?>">
                                                    </div>
                                                    <div class="box2">
                                                    ...
                                                    <div class="box2 password_class">
                                                        <label for=""> كلمة المرور </label>
                                                        <input name="user_password" type="password"
                                                            class="form-control passwordinput" id="floatingInput" value="<?php echo $type[
                                                                'user_password'
                                                            ]; ?>">
                                                        <i class="fa fa-eye"></i>
                                                    </div>
                                                    <div class="box2">
                                                        <label id="name_en">رقـم الجوال<span> * </span></label>
                                                        <input class="form-control" type="text" name="user_phone" value="<?php echo $type[
                                                            'user_phone'
                                                        ]; ?>">
                                                    </div>
                                                    ...
                                                    <div class="box2">
                                                        <label id="name_en">المدينة<span> * </span></label>
                                                        <input class="form-control" type="text" name="user_city" value="<?php echo $type[
                                                            'user_city'
                                                        ]; ?>">
                                                    </div>
                                                    <div class="box2">
                                                    ...
                                                    <div class="box submit_box">
                                                        <input class="btn btn-outline-primary btn-sm" name="add_car"
                                                            type="submit" value="تعديل المستخدم">
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-outline-danger" data-bs-dismiss="modal"> <i
                                        class="fa fa-close"></i> اغلاق</button>
                            </div>
                        </div>
                    </div>
                    <div class='status'></div>
                ...
                <!-- END RECORD TO EDIT NEW RECORD  -->
                <!-- START MODEL VIEW  -->
                <div class="modal fade" id="viewrecord<?php echo $type[
                    'user_id'
                ]; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                                    ...
                                    <div class="myform">
                                        <form class="form-group insert ajax_form"
                                            ...
                                            <div class="row print_content">
                                                <div class="col-lg-12">
                                                    <div class="box2">
                                                        <label id="name_en">الكود الخاص بالمستخدم<span> *
                                                            </span></label>
                                                        <input class="form-control" type="text" name="" value="<?php echo $type[
                                                            'user_code'
                                                        ]; ?>">
                                                    </div>
